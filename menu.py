        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items:
                    ...
                    print(f"{quant} {item_name} added to your order.")

                # Tell the customer they didn't select a menu option
                else:
                    print(f"Item number {menu_selection} isn't a valid option.")
        else:
            # Tell the customer they didn't select a menu option
...
for item in order:
    ...
    num_price_spaces = 5 -len(f"${item_price}")
    num_quant_spaces = 8 - len(f"{item_quant}")
